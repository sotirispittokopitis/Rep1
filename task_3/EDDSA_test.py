...
print(privateKey)
# ----------------------------------------------------------------
# XRPL_transaction - test - message
XRPL_transaction = {
    "Account": "r3J5WiRzJW3PvnsagpXVM8x7MVNucC7Dqm",
    "Destination": "rHimx7SqBaugMDeJsUQm6ybJQPrzkASpgx",
    "Amount": "1000000",
}
# https://www.w3schools.com/python/ref_string_join.asp
concatenated_string = ''.join(XRPL_transaction.values())
